<template>
<div id="page-wrapper" class="licenses-page user-licenses-page">
    <div class=" container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 button-right">
                <span>View as: </span>&nbsp;&nbsp;
                <div role="group" class="btn-group">
                    <router-link to="/admin/licenses" class="btn btn-secondary ">Admin</router-link>
                    <button type="button" class="btn btn-dark active">User</button>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    <template v-for="row in filteredRows">
                                        <tr class="r-line">
                                            ...
                                            <td @click="row.contentVisible = !row.contentVisible" class="">{{row.activeUsers}}</td>
                                            <td @click="row.contentVisible = !row.contentVisible" class="date" v-bind:class="{'status': row.statusKey==3}">
                                            ...
                                            <td class="text-left ">
                                                ...
                                                <a target="_blank" href="https://optumce.com/get-quote/" v-if="row.statusKey==3" class="cursor-pointer color-action">Get quote</a>
